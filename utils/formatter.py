...
class Formatter():
    ...
    def convert_to_html(self, entries):
        ...
        for index, entry in enumerate(entries):
            # title with link
            content += f'<div style="margin-bottom: 1em;"><b>[{index+1}/{len(entries)}] </b><a href="' + entry.source_link + '"><b>' + entry.title + '</b></a>'
            # star link button
            content += '<a href="' + entry.star_link + '" style="margin-left: 0.5em;">' + '<button>Star</button>' + '</a><br>'
